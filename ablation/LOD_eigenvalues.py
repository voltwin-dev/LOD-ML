...
from utils.dataset import PDEBenchDataset_Eigenvalues

# Import models
from models.LOD import LOD
...
def run_training(config):
    ...
    train_data = PDEBenchDataset_Eigenvalues(file_names,
    ...
    val_data = PDEBenchDataset_Eigenvalues(test_file_names,
                            reduced_resolution=reduced_resolution,
                            reduced_resolution_t=reduced_resolution_t,
                            reduced_batch=reduced_batch,
                            initial_step=initial_step,
    ...
    model_path = "./checkpoint/abl_" + model_name + "_" + config.dataset.name + '_eigen_'+ str(N_eigen) +'.pt'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pde', default='abl_eigenvalue')
