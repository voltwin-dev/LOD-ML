...
if __name__ == '__main__':
    ...
    parser.add_argument('--pde', default='make_1D_POD')
    ...
    # PDE stacking
    pde_data = np.zeros((10000, t_range, x_range))
    ...
    rmse_value = np.mean(((pod_pde - pde_data[:9000])**2))**(1/2) # RMSE: 6.090103551002303e-06
